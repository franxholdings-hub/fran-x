...
// Digital products
// ---------------------------------------------------------------------------
// NOTE: every product within a category uses a distinct cover photo so that no
// image repeats on a single store page. Covers are drawn from the licensed
// FRAN-X photo library (see src/lib/photos.ts).
