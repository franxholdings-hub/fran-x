...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FRAN-X | AI, Software & Digital Technology" },
      { name: "description", content: "FRAN-X builds AI solutions, websites, mobile apps, business automation systems, data platforms and custom software for modern businesses." },
      { name: "author", content: "FRAN-X Technologies" },
      { property: "og:title", content: "FRAN-X Technologies" },
      { property: "og:description", content: "Technology for the businesses of tomorrow. AI · Software · Automation · Data." },
